...
VL_INLINE_OPT void Vi2c_master::_sequent__TOP__2(Vi2c_master__Syms* __restrict vlSymsp) {
            ...
            if ((0U == (IData)(vlTOPp->i2c_master__DOT__state))) {
                ...
                if ((1U != (IData)(vlTOPp->i2c_master__DOT__state))) {
                    vlTOPp->i2c_master__DOT__intr_done 
                        = vlTOPp->i2c_master__DOT___GEN_42;
                }
            }
        }
    }
        ...
        if ((1U & (~ (IData)(vlTOPp->reset)))) {
            if ((0U != (IData)(vlTOPp->i2c_master__DOT__state))) {
                vlTOPp->i2c_master__DOT__count = ((1U 
                                                   == (IData)(vlTOPp->i2c_master__DOT__state))
                                                   ? 6U
                                                   : (IData)(vlTOPp->i2c_master__DOT___GEN_41));
            }
        }
    }
    ...
    vlTOPp->i2c_master__DOT__state = ((IData)(vlTOPp->reset)
                                       ? 0U : (IData)(vlTOPp->i2c_master__DOT___GEN_59));
    vlTOPp->i2c_master__DOT___GEN_42 = ((2U == (IData)(vlTOPp->i2c_master__DOT__state))
...
void Vi2c_master::_settle__TOP__3(Vi2c_master__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->i2c_master__DOT___GEN_59 = ((IData)(vlTOPp->reset)
                                         ? 0U : ((0U 
                                                  == (IData)(vlTOPp->i2c_master__DOT__state))
                                                  ? 
                                                ...
                                                : (
                                                   ...
                                                   ((5U 
                                                    ...
                                                    ((6U 
                                                      != (IData)(vlTOPp->i2c_master__DOT__state)) 
                                                     | (IData)(vlTOPp->io_i2c_sda_in)))))))));
    vlTOPp->i2c_master__DOT___GEN_41 = ((2U == (IData)(vlTOPp->i2c_master__DOT__state))
...
void Vi2c_master::_ctor_var_reset() {
    ...
    i2c_master__DOT___GEN_41 = VL_RAND_RESET_I(15);
    i2c_master__DOT___GEN_42 = VL_RAND_RESET_I(1);
    i2c_master__DOT___GEN_59 = VL_RAND_RESET_I(3);
