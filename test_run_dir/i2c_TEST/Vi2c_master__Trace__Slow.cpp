...
void Vi2c_master::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+12,"io_ack", false,-1);
        tracep->declBit(c+13,"io_data_ack", false,-1);
        tracep->declBit(c+14,"io_i2c_sda", false,-1);
        tracep->declBit(c+15,"io_i2c_scl", false,-1);
        tracep->declBit(c+16,"io_ready", false,-1);
        tracep->declBit(c+17,"io_stop", false,-1);
        ...
        tracep->declBit(c+12,"i2c_master io_ack", false,-1);
        tracep->declBit(c+13,"i2c_master io_data_ack", false,-1);
        tracep->declBit(c+14,"i2c_master io_i2c_sda", false,-1);
        tracep->declBit(c+15,"i2c_master io_i2c_scl", false,-1);
        tracep->declBit(c+16,"i2c_master io_ready", false,-1);
        tracep->declBit(c+17,"i2c_master io_stop", false,-1);
        ...
        tracep->declBus(c+4,"i2c_master saved_data", false,-1, 7,0);
        tracep->declBit(c+5,"i2c_master i2c_scl_enable", false,-1);
    }
}
...
void Vi2c_master::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+4,(vlTOPp->i2c_master__DOT__saved_data),8);
        tracep->fullBit(oldp+5,(vlTOPp->i2c_master__DOT__i2c_scl_enable));
        ...
        tracep->fullBit(oldp+12,(vlTOPp->io_ack));
        tracep->fullBit(oldp+13,(vlTOPp->io_data_ack));
        tracep->fullBit(oldp+14,(vlTOPp->io_i2c_sda));
        tracep->fullBit(oldp+15,(vlTOPp->io_i2c_scl));
        tracep->fullBit(oldp+16,(vlTOPp->io_ready));
        tracep->fullBit(oldp+17,(vlTOPp->io_stop));
    }
}
