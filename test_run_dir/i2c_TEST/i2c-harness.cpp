...
#endif
#include <iostream>
class i2c_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    i2c_api_t(Vi2c* _dut) {
        dut = _dut;
        main_time = 0L;
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["i2c.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    Vi2c* top = new Vi2c;
    std::string vcdfile = "test_run_dir/i2c_TEST/i2c.vcd";
