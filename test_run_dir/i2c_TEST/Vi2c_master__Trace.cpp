...
void Vi2c_master::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+3,(vlTOPp->i2c_master__DOT__i2c_scl_enable));
            tracep->chgBit(oldp+4,(vlTOPp->i2c_master__DOT__intr_done));
        }
        ...
        tracep->chgBit(oldp+11,(vlTOPp->io_i2c_sda_in));
        tracep->chgBit(oldp+12,(vlTOPp->io_i2c_sda));
        tracep->chgBit(oldp+13,(vlTOPp->io_i2c_scl));
        tracep->chgBit(oldp+14,(vlTOPp->io_ready));
        tracep->chgBit(oldp+15,(vlTOPp->io_stop));
        tracep->chgBit(oldp+16,(vlTOPp->io_i2c_intr));
    }
}
