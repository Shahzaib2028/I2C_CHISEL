...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/i2c_Top_TEST/I2C_Top.vcd";
    ...
    Verilated::mkdir("test_run_dir/i2c_Top_TEST/logs");
    VerilatedCov::write("test_run_dir/i2c_Top_TEST/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
